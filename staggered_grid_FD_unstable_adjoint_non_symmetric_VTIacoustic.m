...
% solving the unstable adjoint equation of the 2D non symmetric VTI acoustic with staggered finite difference
...
fileName = 'staggered_grid_FD_unstable_adjoint_non_symmetric_VTIacoustic.mat';
...
for it = 1:nt
    ...
    if mod(it-1, dsnap) == 0 && it > 1
        ...
        title(['Unstable adjoint of non-symmetric: P Snapshot at ', num2str(dt*(it - 1)*1000), ' ms']);
